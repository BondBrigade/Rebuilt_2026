...
/**
 * PREVIOUSLY: AbsoluteFieldDrive
 */
public class SwerveFieldDrive extends Command {
   ...
   */
  public SwerveFieldDrive(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY,
  ...
  public void execute() {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
        Constants.Swerve.loopTime, Constants.Swerve.robotMass, List.of(Constants.Swerve.chassis),
